...
;(function ($, undefined) {
  ...
  $.fn.mooodal = function (options) {
    ...
    var modalLoad = function modalLoad() {
    ...
    var showOverlay = function showOverlay(target) {
      if (opt.overlay == true) {
    ...
    var modalLaunch = function modalLaunch(target, callback) {
    ...
    var modalFade = function modalFade(target, method) {
      var def = new $.Deferred();
    ...
    var modalClose = function modalClose(target, method) {
